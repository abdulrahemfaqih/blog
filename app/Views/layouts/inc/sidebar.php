        ...
        <div class="pt-16">
            <nav class="mt-6">
                <div class="px-4 space-y-2">
                    <!-- Dashboard Menu -->
                    <a href="<?= base_url('dashboard') ?>" class="flex items-center px-4 py-2 text-gray-700 rounded-lg <?= is_active('dashboard') ?>">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="submenu pl-8 space-y-1 hidden overflow-y-auto max-h-48">
                            <a href="../components/input.html"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-lg">Input</a>
                        </div>
                    </div>
